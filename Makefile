...
HOSTCC = gcc
HOSTCFLAGS = -Wall -Wextra -Wshadow -Wstrict-prototypes  -g -O0
...
CFLAGS = -Wall -Wextra -Wshadow -Wstrict-prototypes  -g -O0
CXXFLAGS = -Wall -Wextra -Wshadow   -g -O0 -std=c++11
PICFLAGS = -fPIC
LDFLAGS = -rdynamic  
CTARGETFLAGS = 
...
ivl: $O $(srcdir)/ivl.def
	$(CXX) $(LDFLAGS) -o ivl -Wl,--out-implib=libivl.a $(srcdir)/ivl.def $O $(dllib) 
else
ivl: $O
